...
//                alert(nameReq.readystate);
        ...
        <div class="col-md-6 log">			 
            ...
            <form action="login" method="post">
                <h5>User Name:</h5>	
                <input type="text" name="loginName" id="loginNameId" onblur="checkName()" autofocus/><span id="nameSpan" style="font-size:12px;font-style: italic;margin-left: 10px;color: #F18743;"></span>
                <h5>Password:</h5>
